...
UniValue validateaddressgeneric(const UniValue& params, bool fHelp, const CPubKey& mypk)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "validateaddressgeneric \"address\"\n"
            "\nReturn information about the given BTC-fork address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The BTC-fork address to validate\n"
            "2. \"PUBKEY_ADDRESS\"     (string, required) The PUBKEY_ADDRESS type\n"
            "3. \"SCRIPT_ADDRESS\"     (string, required) The SCRIPT_ADDRESS type\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\",   	 (string) The BTC-fork address validated\n"
	    "  \"komodoaddress\" : \"address\",  (string) The corresponding komodo address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isscript\" : true|false,        (boolean) If the key is a script\n"
            "  \"pubkey\" : \"publickeyhex\",    (string) The hex value of the raw public key\n"
    ...
    if (isValid)
    {
        ...
        ret.push_back(Pair("komodoaddress", currentAddress));
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "util",               "validateaddressgeneric", &validateaddressgeneric, true  }, /* uses wallet if enabled */
